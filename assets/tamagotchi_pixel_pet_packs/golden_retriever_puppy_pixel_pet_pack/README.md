# Playful Golden Retriever Puppy Garmin Pixel Pet Pack

Classic 16-bit virtual pet asset pack for small Garmin MIP/AMOLED screens.

- Character: Playful Golden Retriever Puppy.
- Native transparent PNGs: `43` files in `native/`.
- 4x nearest-neighbor reference PNGs: `43` files in `upscaled_4x/`.
